...
const Banner = () => {
  ...
  return (
    <section className="py-0 top-position1 banner-style01">
              ...
              <div className="row align-items-center min-vh-100 text-center justify-content-center">
                <div className="col-lg-8">
                  <div className="mt-5 mt-sm-0">
                    ...
                    <h1 className="mb-2-9 main-title text-white">{slide.title}</h1>
                    <p className="text-white mb-4">
                      Generate images, audio, profiles and powerful AI content in seconds using our advanced AI platform.
                    </p>
      ...
      <img src={shape1} className="position-absolute right-5 top-10 z-index-3 ani-left-right d-none d-md-block" alt="..." />
